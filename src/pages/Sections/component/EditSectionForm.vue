...
(function () {
  ...
  methods: {
    ...
    .then((res) => {
      ...
      this.sections.slug =  res.data.Section.slug;
          ...
          if (error) {
            ...
            // console.log(error.response.headers);
             ...
             alert(`error !! Sorry section by id request had error we can not return old data.. work soon`);
          }
        })
      axios
  ...
  updateSections() {
    var self = this;
      ...
      document.getElementById(`m`).classList.toggle('cvs');
        ...
        axios
        .put(
           `/api/sections/update/${this.$route.params.id}`,
          this.sections
        )
        .then(function(response) {
          ...
          self.Massage_success ='Update sections Request Success do you want go to category tabel';
