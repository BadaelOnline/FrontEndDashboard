        ...
        <div class="col-md-6">
          ...
          <div class="valid-feedback">
            Looks good!
                       ...
                       <div class="col-md-6">
          <label for="validationCustom02" class="form-label">selling_price</label>
          <input
            type="text"
            class="form-control"
            id="validationCustom02"
          ...
          <div class="valid-feedback">
            Looks good!
                ...
                <div class="col-md-6">
          <label for="validationCustom01" class="form-label">short_description </label>
          <input
            type="text"
            class="form-control"
            id="validationCustom01"
          ...
          <div class="valid-feedback">
            Looks good!
                ...
                <div class="col-md-6">
          <label for="validationCustom01" class="form-label">long_description </label>
          <input
            type="text"
            class="form-control"
            id="validationCustom01"
...
"message":"you have new offer"
  ...
  methods: {
    ...
    formSubmit(e) {
      ...
      axios
        .post(`/api/offer/image/${self.new_offer_id}`, data, {
        ...
        axios
          ...
          .then(function(response) {
            console.log(response.data);
               self.new_offer_id = response.data.offer[0] ;
            if (response.data.stateNum == 201 || self.statusnumber == 200) {
              document.getElementById("sp").classList.toggle("cvs");
              self.statusnumber = response.data.stateNum;
              self.Massage_success = "Create Offer Request Success..Now you can upload img";
              document.getElementById("su").classList.toggle("cvs");
              setTimeout(() => {
                document.getElementById("su").classList.toggle("cvs");
              }, 2000);
