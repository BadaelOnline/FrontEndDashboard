      ...
      <md-card-content>
        <div>
              ...
              <md-card-header data-background-color="dataBackgroundColor">
                <md-field class="md-layout-item  md-size-100">
                  ...
                  <md-select
                    ...
                    v-model="products.sections.section_id"
                    name="font"
                    id="font"
                    md-dense
                  >
              ...
              <md-card-header data-background-color="dataBackgroundColor">
                <md-field class="md-layout-item  md-size-100">
                  ...
                  <md-select
                    ...
                    v-model="products.category.category_id"
                    name="font"
                    id="font"
                    md-dense
                  >
          ...
          <div class="md-layout md-medium-size-100 ">
            <md-button @click="updateProduct()">Update</md-button>
          </div>
        </div>
      </md-card-content>
    </md-card>
...
import UploadImagesProduct from "./UploadImagesProduct.vue";
export default {
  ...
  methods: {
    ...
    updateProduct() {
      ...
      if (
        this.products.product[1].name == null ||
        this.products.category.category_id == null ||
        this.products.brand_id == null ||
        this.products.sections.section_id == null
      ) {
